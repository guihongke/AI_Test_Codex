...
public abstract class VClassicsAbstract<T extends VClassicsAbstract<?>> extends VSimpleComponent implements VRefreshComponent {
    ...
    protected VRefreshKernel mRefreshKernel;
    protected VPaintDrawable mArrowDrawable;
    protected VPaintDrawable mProgressDrawable;
    ...
    public VClassicsAbstract(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mMinHeightOfContent == 0) {
            ...
            if (mPaddingTop == 0 || mPaddingBottom == 0) {
                ...
                mPaddingTop = mPaddingTop == 0 ? VSmartUtil.dp2px(20) : mPaddingTop;
                mPaddingBottom = mPaddingBottom == 0 ? VSmartUtil.dp2px(20) : mPaddingBottom;
    ...
    public T setSpinnerStyle(VSpinnerStyle style) {
    ...
    public T setDrawableMarginRight(float dp) {
        ...
        lpArrow.rightMargin = lpProgress.rightMargin = VSmartUtil.dp2px(dp);
    ...
    public T setDrawableSize(float dp) {
        ...
        lpArrow.width = lpProgress.width = VSmartUtil.dp2px(dp);
        lpArrow.height = lpProgress.height = VSmartUtil.dp2px(dp);
        arrowView.setLayoutParams(lpArrow);
        progressView.setLayoutParams(lpProgress);
        return self();
    }
    ...
    public T setDrawableArrowSize(float dp) {
        final View arrowView = mArrowView;
        ViewGroup.LayoutParams lpArrow = arrowView.getLayoutParams();
        lpArrow.height = lpArrow.width = VSmartUtil.dp2px(dp);
        arrowView.setLayoutParams(lpArrow);
        return self();
    }
    ...
    public T setDrawableProgressSize(float dp) {
        final View progressView = mProgressView;
        ViewGroup.LayoutParams lpProgress = progressView.getLayoutParams();
        lpProgress.height = lpProgress.width = VSmartUtil.dp2px(dp);
        progressView.setLayoutParams(lpProgress);
        return self();
    }
