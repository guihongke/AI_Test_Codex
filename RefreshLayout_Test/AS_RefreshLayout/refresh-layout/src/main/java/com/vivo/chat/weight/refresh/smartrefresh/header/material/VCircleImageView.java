 ...
 */
package com.vivo.chat.weight.refresh.smartrefresh.header.material;
...
public class VCircleImageView extends ImageView {
    ...
    public VCircleImageView(Context context, int color) {
        super(context);
...
//
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final View thisView = VCircleImageView.this;
